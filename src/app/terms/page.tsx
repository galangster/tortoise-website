...
export default function TermsOfService() {
  return (
    <div className="min-h-screen bg-ink-900">
      {/* Header */}
      <header className="bg-ink-850 border-b border-white/10">
        <div className="max-w-4xl mx-auto px-4 py-8">
          <Link href="/" className="inline-flex items-center gap-2 text-cloud-muted hover:text-tortoise-primary transition-colors">
            <span className="text-2xl">←</span>
            <span className="font-bold">Back to Home</span>
          </Link>
          
          <h1 className="text-4xl font-black text-cloud mt-6">Terms of Service</h1>
          <p className="text-cloud-muted mt-2">Last updated: February 20, 2024</p>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <div className="prose prose-lg max-w-none">
          <p className="text-xl text-cloud-muted mb-8">
          ...
          <h2 className="text-2xl font-black text-cloud mt-8 mb-4">1. Acceptance of Terms</h2>
          ...
          <h2 className="text-2xl font-black text-cloud mt-8 mb-4">2. Description of Service</h2>
          
          <p>Tortoise provides:</p>
          
          <ul className="list-disc pl-6 space-y-2 text-cloud-muted">
          ...
          <h2 className="text-2xl font-black text-cloud mt-8 mb-4">3. Account Registration</h2>
          ...
          <h2 className="text-2xl font-black text-cloud mt-8 mb-4">4. Subscription and Payments</h2>

          <h3 className="text-xl font-bold text-cloud mt-6 mb-3">Free Tier</h3>
          <p>
          ...
          <h3 className="text-xl font-bold text-cloud mt-6 mb-3">Premium Subscriptions</h3>
          ...
          <h2 className="text-2xl font-black text-cloud mt-8 mb-4">5. Health and Safety Disclaimer</h2>
          
          <p className="my-4 rounded-2xl bg-tortoise-shell/10 p-4 text-cloud ring-1 ring-tortoise-shell/30">
            <strong className="text-tortoise-shell">Important:</strong> Tortoise is a fitness tool, not medical advice. Always consult
          ...
          <h2 className="text-2xl font-black text-cloud mt-8 mb-4">6. User Content</h2>
          ...
          <h2 className="text-2xl font-black text-cloud mt-8 mb-4">7. Intellectual Property</h2>
          ...
          <h2 className="text-2xl font-black text-cloud mt-8 mb-4">8. Third-Party Services</h2>
          ...
          <h2 className="text-2xl font-black text-cloud mt-8 mb-4">9. Limitation of Liability</h2>
          ...
          <h2 className="text-2xl font-black text-cloud mt-8 mb-4">10. Termination</h2>
          ...
          <h2 className="text-2xl font-black text-cloud mt-8 mb-4">11. Dispute Resolution</h2>
          
          <p>Any disputes arising from these Terms shall be resolved through:</p>
          
          <ol className="list-decimal pl-6 space-y-2 text-cloud-muted">
          ...
          <h2 className="text-2xl font-black text-cloud mt-8 mb-4">12. Governing Law</h2>
          ...
          <h2 className="text-2xl font-black text-cloud mt-8 mb-4">13. Changes to Terms</h2>
          ...
          <h2 className="text-2xl font-black text-cloud mt-8 mb-4">14. Contact Information</h2>
          ...
          <div className="mt-12 p-6 bg-ink-800 rounded-2xl ring-1 ring-white/10">
