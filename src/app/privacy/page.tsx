    ...
    <div className="min-h-screen bg-ink-900">
      ...
      <header className="bg-ink-850 border-b border-white/10">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <h1 className="text-4xl font-black text-cloud mt-6">Privacy Policy</h1>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-black text-cloud mt-8 mb-4">1. Information We Collect</h2>
          
          <h3 className="text-xl font-bold text-cloud mt-6 mb-3">Personal Information</h3>
          ...
          <h3 className="text-xl font-bold text-cloud mt-6 mb-3">Health & Fitness Data</h3>
          ...
          <h3 className="text-xl font-bold text-cloud mt-6 mb-3">Usage Data</h3>
          ...
          <h2 className="text-2xl font-black text-cloud mt-8 mb-4">2. How We Use Your Information</h2>
          ...
          <h2 className="text-2xl font-black text-cloud mt-8 mb-4">3. Data Sharing and Disclosure</h2>
          ...
          <h2 className="text-2xl font-black text-cloud mt-8 mb-4">4. Your Privacy Rights</h2>
          ...
          <h2 className="text-2xl font-black text-cloud mt-8 mb-4">5. Data Security</h2>
          ...
          <h2 className="text-2xl font-black text-cloud mt-8 mb-4">6. Data Retention</h2>
          ...
          <h2 className="text-2xl font-black text-cloud mt-8 mb-4">7. Children's Privacy</h2>
          ...
          <h2 className="text-2xl font-black text-cloud mt-8 mb-4">8. International Data Transfers</h2>
          ...
          <h2 className="text-2xl font-black text-cloud mt-8 mb-4">9. Changes to This Policy</h2>
          ...
          <h2 className="text-2xl font-black text-cloud mt-8 mb-4">10. Contact Us</h2>
